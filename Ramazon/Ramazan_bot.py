...
from Ramazon.sqlite import bot_token, DB_NAME
...
def start(update, context):
    ...
    update.message.reply_html(f"<b>Assalomu alekum </b> {user.first_name} "
                              f"\n<b>Ramazon botga xush kelibsiz 🌞.</b> "
                              f"\n<b>Sizga qaysi mintaqa bo'yicha malumot beray!</b>",
...
def today(update, context):
    ...
    try:
        ...
        update.message.reply_photo(photo=open("images/Ro.jpg", "rb"), caption=message, parse_mode="HTML",
...
def tommoro(update, context):
    ...
    try:
        ...
        update.message.reply_photo(caption=message, photo=open("images/Ro.jpg", "rb"), parse_mode="HTML",
                                   reply_markup=main_button)
    except Exception as o:
        print(o)
...
def select_region(update, context):
    ...
    update.message.reply_text("Qaysi mintaqa bo'yicha malumot kerak?", reply_markup=InlineKeyboardMarkup(buttons))
    return STATE_REGION


def select_duo(update, context):
    update.message.reply_photo(photo=open("images/Duo_ramazon.jpg", "rb"), caption="<b>Ramazon oyida tutgan Ro'zalaringiz "
                                                                            "qabul bo'lsin "
                                                                            "va barchamizga Sabr,Madad yor bo'lsin</b>",
                               parse_mode="HTML",
                               reply_markup=main_button)
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            STATE_CALENDAR: {
                ...
                MessageHandler(Filters.regex('^(' + ertaga + ')$'), tommoro),
