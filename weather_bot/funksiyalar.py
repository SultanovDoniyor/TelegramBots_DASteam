...
def start(update, context):
	...
	salom =f'Assalomu Aleykum <b>{user.first_name}</b> 🤝. uzbweather_bot ga xush kelibsiz !!! \n ' f' \nSizga foydamiz tegganidan xursandmiz😊. Iltimos hududni tanlang'
	update.message.reply_photo(photo=open('preview-logo-ru.png'), caption=salom, reply_markup=hududlar_button)
...
def admin(update,context):
	update.message.reply_text("Admin👨🏻‍💻 bilan bog'lanish - @lBeat_Booml ")
